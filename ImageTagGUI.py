...
class Gui():
	def __init__(self, root):
		...
		DAMAGES = [
			...
			("Soft story failure", "SoftStoryFail"),
		...
		STRUCTURES = [
			...
			("Full story", "Interac"),
			("Partial/full building", "SlabFrac"),
			("Unknown", "PunchShearFrac"),
		]    		
	...
	def about(self):
		essagebox.showinfo("Information","C.I.T.T Civil Infrastructure Tagging Tool: \nVersion 1.0. \nUpdated  October 2017. \nDeveloped by:\nMaria Pantoja and Anahid Behrouzi \nCalPoly SLO")
